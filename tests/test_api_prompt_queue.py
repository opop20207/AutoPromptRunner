...
class PromptQueueApiTests(unittest.TestCase):
    ...
    def test_inject_complete_flow(self):
        ...
        self._add(qid, "P34")
        self._add(qid, "P35")
        inj = self.client.post(f"/prompt-queues/{qid}/inject-current", json={})
        ...
        self.assertEqual(self.client.post(f"/prompt-queues/{qid}/inject-current", json={}).status_code, 409)
    ...
    def test_pause_blocks_inject_then_resume(self):
        ...
        self.assertEqual(self.client.post(f"/prompt-queues/{qid}/inject-current", json={}).status_code, 200)
